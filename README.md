...
### 요약
- **CDN 도입의 필요성:** S3단독 사용보다 CloudFront와 같은 CDN을 도입하면 성능을 향상 시킬 수 있습니다.
- **캐시 전략 최적화:** CloudFront의 캐싱을 활용해 S3요청을 줄이고, 사용자와 가까운 엣지 서버에서 콘텐츠를 제공하여 로드 시간을 단축합니다.
- **비용 관리:** S3와 CloudFront의 비용 구조를 비교해 트래픽 양과 네트워크 요청 빈도에 따라 최적의 비용 효율을 달성합니다.

### 결론
CloudFront를 통한 배포는 성능 개선과 글로벌 사용자 경험 향상을 제공하며, 캐시전략을 바탕으로 비용 효율성도 확보할 수 있습니다.
